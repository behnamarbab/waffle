...
#ifdef USE_TRACE_PC
    SAYF(cCYA "waffle-fuzzer: waffle-clang [tpcg] " cBRI VERSION  cRST " by <wcventure@126.com>\n");
#else
    SAYF(cCYA "waffle-fuzzer: waffle-clang " cBRI VERSION  cRST " by <wcventure@126.com>\n");
#endif /* ^USE_TRACE_PC */
